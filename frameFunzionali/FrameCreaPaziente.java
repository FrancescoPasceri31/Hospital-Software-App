...
import listenerFrameDoc.ClickPerCrearePaziente;
...
public class FrameCreaPaziente extends JFrame
{
    private JTextField nomeText;
    private JTextField codFiscaleText;
    private JTextField cognomeText;
    
    public FrameCreaPaziente(final JFrame frame, final Medico m) {
        this.setTitle("Nuovo Paziente");
        ...
        final String[] sessoScelta = { "Maschio", "Femmina" };
        final JComboBox<String> comboBoxSesso = new JComboBox<String>(sessoScelta);
        ...
        btnSalva.addMouseListener(new ClickPerCrearePaziente(this.nomeText, this.codFiscaleText, this.cognomeText, dateChooser, comboBoxSesso, m.getTipoReparto(), frame, m));
